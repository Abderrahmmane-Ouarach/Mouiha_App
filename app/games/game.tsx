...
const WATER_THEMES: ThemesMap = {
  1: { title: 'بداية التوفير', icons: ['💧', '💧', '🚿', '🚿'], tips: ['أغلق الصنبور عند غسل أسنانك', 'استحم بسرعة أكبر'], fact: 'توفير دقيقة واحدة من الاستحمام = 19 لتر!', color: '#3498DB', difficulty: '⭐ سهل', targetTime: 25, reward: '🏆 موفر مبتدئ' },
  2: { title: 'البيت الذكي', icons: ['🏠', '🏠', '🔧', '🔧', '💡', '💡'], tips: ['أصلح الصنبور المتسرب فوراً', 'اجمع مياه المطر في وعاء', 'استخدم الغسالة عندما تكون ممتلئة'], fact: 'إصلاح تسرب صغير يوفر 35 لتر يومياً', color: '#2ECC71', difficulty: '⭐⭐ متوسط', targetTime: 35, reward: '🏆 خبير المنزل' },
  3: { title: 'حارس البيئة', icons: ['🌱', '🌱', '♻️', '♻️', '🏭', '🏭', '🛡️', '🛡️'], tips: ['لا تلقي القمامة في النهر', 'ازرع النباتات في حديقتك', 'استخدم منتجات صديقة للبيئة', 'شارك في تنظيف الشواطئ'], fact: 'النباتات تنظف المياه بشكل طبيعي', color: '#E74C3C', difficulty: '⭐⭐⭐ صعب', targetTime: 45, reward: '🏆 حامي البيئة' },
  4: { title: 'تقني المياه', icons: ['⚙️', '⚙️', '🌳', '🌳', '🔬', '🔬', '📱', '📱', '💻', '💻'], tips: ['استخدم الري بالتنقيط للنباتات', 'راقب استهلاك المياه بتطبيق', 'جرب تقنيات توفير المياه الجديدة', 'علم أصدقاءك طرق التوفير', 'استخدم أجهزة قليلة الاستهلاك'], fact: 'التقنيات الحديثة توفر 50% من المياه', color: '#9B59B6', difficulty: '⭐⭐⭐⭐ خبير', targetTime: 55, reward: '🏆 مهندس المياه' },
  5: { title: 'بطل المياه', icons: ['🌍', '🌍', '👥', '👥', '❤️', '❤️', '🤝', '🤝', '⭐', '⭐', '🏆', '🏆'], tips: ['علم الآخرين أهمية توفير المياه', 'شارك في مشاريع المياه المحلية', 'كن قدوة في مجتمعك', 'ادعم المنظمات البيئية', 'انشر الوعي على وسائل التواصل', 'احتفل بإنجازاتك في التوفير'], fact: 'تأثيرك الإيجابي يمكن أن ينقذ آلاف اللترات!', color: '#34495E', difficulty: '⭐⭐⭐⭐⭐ بطل', targetTime: 65, reward: '👑 أسطورة المياه' },
  6: { title: 'خبير عالمي', icons: ['🌊', '🌊', '🔬', '🔬', '🏭', '🏭', '🌍', '🌍', '⚗️', '⚗️', '🚀', '🚀', '🔮', '🔮'], tips: ['ادرس تقنيات تحلية المياه المتقدمة', 'افهم دورة المياه في الطبيعة', 'تعلم معالجة المياه الملوثة', 'اكتشف توليد المياه من الهواء', 'شارك في البحث العلمي', 'طوّر حلولاً مبتكرة', 'كن سفيراً للمياه في العالم'], fact: 'الابتكار في تقنيات المياه يمكن أن يغير العالم!', color: '#1ABC9C', difficulty: '⭐⭐⭐⭐⭐⭐ أسطورة', targetTime: 75, reward: '🌟 سفير المياه العالمي' },
  7: { title: 'أمطار وخزانات', icons: ['☔', '☔', '🧰', '🧰', '🧼', '🧼', '🐟', '🐟'], tips: ['ركّب خزان تجميع أمطار', 'صيانة دورية للأنابيب', 'استخدم دلوًا لغسل السيارة', 'احمِ الأنهار من الملوثات'], fact: 'جمع 100 لتر مطر يكفي ريّ حديقة صغيرة لأيام.', color: '#0EA5E9', difficulty: '⭐⭐⭐ صعب', targetTime: 50, reward: '💠 جامع المطر' },
  8: { title: 'مناخ واعٍ', icons: ['🏜️', '🏜️', '🪴', '🪴', '🔧', '🔧', '💡', '💡', '🌱', '🌱'], tips: ['الريّ صباحًا/مساءً', 'نباتات قليلة الاستهلاك', 'سدّ التسريبات فورًا', 'أجهزة موفّرة', 'تربة مُغطّاة تقلل التبخر'], fact: 'التغطية العضوية للتربة تقلل فقد الماء حتى 70%.', color: '#16A34A', difficulty: '⭐⭐⭐⭐ خبير', targetTime: 60, reward: '🌿 صديق المناخ' },
  9: { title: 'مختبر المنزل', icons: ['🧪', '🧪', '⚗️', '⚗️', '📱', '📱', '💻', '💻', '🔬', '🔬', '🏠', '🏠'], tips: ['اختبر جودة الماء دوريًا', 'رشّح الماء بدل شراء البلاستيك', 'تابع الاستهلاك عبر التطبيق', 'حلّل الأنماط لتعرف الهدر'], fact: 'الترشيح المنزلي يقلل القوارير البلاستيكية آلافًا سنويًا.', color: '#7C3AED', difficulty: '⭐⭐⭐⭐ خبير', targetTime: 70, reward: '🧠 كيميائي ذكي' },
  10: { title: 'مجتمع متعاون', icons: ['👥', '👥', '🤝', '🤝', '❤️', '❤️', '🐟', '🐟', '🌍', '🌍', '⭐', '⭐', '🏆', '🏆'], tips: ['حملات تنظيف', 'ورش توعية', 'مشاركة قصص نجاح', 'إنشاء حدائق مائية صديقة'], fact: 'العمل الجماعي يضاعف الأثر التوفيري والفائدة البيئية.', color: '#475569', difficulty: '⭐⭐⭐⭐⭐ بطل', targetTime: 80, reward: '🏅 قائد المجتمع' },
  11: { title: 'ابتكار متقدم', icons: ['🚀', '🚀', '🔮', '🔮', '⚙️', '⚙️', '🌊', '🌊', '🧰', '🧰', '☔', '☔', '🧪', '🧪', '💡', '💡'], tips: ['نماذج تنبؤية للهدر', 'أجهزة إنترنت الأشياء', 'صيانة استباقية', 'حصاد أمطار حضري'], fact: 'المستشعرات الذكية تكشف التسريب خلال دقائق.', color: '#0F766E', difficulty: '⭐⭐⭐⭐⭐⭐ أسطورة', targetTime: 95, reward: '🔧 مهندس المستقبل' },
  12: { title: 'أسطورة الماء', icons: ['🌍','🌍','💧','💧','🚿','🚿','🧪','🧪','🪴','🪴','🐟','🐟','☔','☔','🔧','🔧','🚀','🚀','🔮','🔮'], tips: ['نمذجة استهلاك الأسرة', 'خطط طوارئ للجفاف', 'تعليم الأجيال الصغيرة'], fact: 'إستراتيجية متكاملة على مستوى البيت والحي تُحدِث فارقًا ملحوظًا.', color: '#1F2937', difficulty: '⭐⭐⭐⭐⭐⭐⭐ أسطورة عليا', targetTime: 110, reward: '👑 أسطورة الماء الكبرى' },
};
